<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Add the connection parameters in the <code>chat.models.db</code> namespace.
...
Two middleware functions are provided by default in the `chat.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `chat.handler` namespace to manage the enabled middleware.
